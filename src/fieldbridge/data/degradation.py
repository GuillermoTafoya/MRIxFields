...
These transforms are deliberately lightweight and deterministic when supplied a
``torch.Generator``. They are not a physically accurate MRI simulator; they only
provide synthetic low-field-like corruption for interface and pretraining tests.
"""
