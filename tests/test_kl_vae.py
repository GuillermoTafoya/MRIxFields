...
def test_decoder_exposes_downsample_factor_like_the_encoder() -> None:
    ...
    path. The stage-2 eval tests stub the decoder, so only a real one catches a missing
    attribute -- which is how the held-out gate crashed after the suite was green."""
