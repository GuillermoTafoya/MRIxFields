...
def test_threshold_mask_preserves_shape_and_returns_binary_values() -> None:
...
def test_clean_brain_mask_preserves_3d_shape_and_binary_values() -> None:
    x = torch.zeros(1, 1, 4, 7, 7)
    x[:, :, :, 2:5, 2:5] = 1.0
