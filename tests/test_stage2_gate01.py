...
def _protocol_lock(calibrator, traveller_hash: str, selection_fingerprint: str):
    return Gate01ProtocolLock(
        ...
        split_fingerprint=RESPLIT_FINGERPRINT,
        evaluation_split_file_sha256="6" * 64,
...
def _producer_receipt(lock: Gate01ProtocolLock) -> dict:
    ...
    return {
        ...
        "producer_spec_contract_version": "stage2-gate01-private-producer-spec-v4",
        "producer_state_contract_version": "stage2-gate01-private-producer-state-v3",
        ...
        "producer_receipt": {
            "contract_version": "stage2-gate01-private-producer-receipt-v2",
            "producer_spec_artifact_sha256": producer_spec_artifact,
...
def _evaluate(
    *,
    ...
    return evaluate_gate01(
        ...
        split_provenance=(protocol_lock.split_provenance if protocol_lock else None),
...
def test_protocol_lock_is_independent_and_hash_sealed(tmp_path) -> None:
    ...
    with pytest.raises(ValueError, match="independent protocol lock"):
        loaded.assert_manifest_contract(
            ...
            split_fingerprint=RESPLIT_FINGERPRINT,
            split_provenance=loaded.split_provenance,
            support_threshold=0.0,
            artifact_provenance=frozen_artifact_provenance(),
        )
...
def test_evaluator_streams_cases_with_bounded_full_volume_liveness() -> None:
    ...
    result = evaluate_gate01(
        ...
        split_provenance=protocol_lock.split_provenance,
